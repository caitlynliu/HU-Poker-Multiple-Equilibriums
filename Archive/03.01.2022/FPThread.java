...
public class FPThread extends Thread {
    ...
    FPThread(String name, FP fictitiousPlay, Strategies strategy1, Strategies strategy2, int hand, int playerNum, int iteration, PrintWriter printWriter, double equiPrecision){
        threadName = name;
        fp = fictitiousPlay;
        strat1 = strategy1;
        strat2= strategy2;
    ...
    public void run(){
        ...
        if(player == 1 && (a1Payoff+1.5) > 0 || player == 2 && (-a1Payoff) > 0 ){
                newFq = oldFq+1;
