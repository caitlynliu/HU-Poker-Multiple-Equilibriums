...
public class FP {
    ...
    HandPayoff payoffMatrix1, payoffMatrix2;
    Converter converter;
    int equilibrium;
    public FP(String strat1, String strat2, String stackSize1, String stackSize2) throws FileNotFoundException, IOException{
        ...
        String payoffFile1 = "payoff"+stackSize1+".csv";
        String payoffFile2 = "payoff"+stackSize2+".csv";
        payoffMatrix1 = new HandPayoff(payoffFile1);
        payoffMatrix2 = new HandPayoff(payoffFile2);
...
*/  
    public double expectedPayoff(Strategies strategy1, Strategies strategy2, int h1, int player){
        ...
        for(int i = 0; i<1326; i++){
            ...
            if(player==1){
                newPayoff = payoffMatrix1.getPayoff(h1,i);
            }
            else{
                newPayoff = payoffMatrix2.getPayoff(i,h1); 
            }
            /** 
    ...
    */
    ...
    public void printStrategies(long time, double precision, int strategy, String stacksize) throws IOException{
        ...
        fileName.append(Double.toString(precision));
